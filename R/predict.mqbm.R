...
#'   probabilities (ECDF-transformed values). Each prediction is generated by the
#'   symbol-specific model and transformed through the corresponding symbol's ECDF
#'   function built from training y values. Values range from 0 to 1.
#'
#' @details
...
predict.mqbm <- function(object, newdata, multi = NULL, symbol = NULL, ...) {
  ...
  # Predict for each symbol using its corresponding model and apply ECDF
