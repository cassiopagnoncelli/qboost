...
#' @export
#' @method plot qrb
plot.qrb <- function(x, plot = TRUE, top_features = 25, ...) {
  if (!inherits(x, "qrb")) {
    stop("`x` must be a qrb model.", call. = FALSE)
  }
