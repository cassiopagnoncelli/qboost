...
#' @export
#' @method plot qbm
plot.qbm <- function(x, plot = TRUE, top_features = 25, ...) {
  if (!inherits(x, "qbm")) {
    stop("`x` must be a qbm model.", call. = FALSE)
  }
